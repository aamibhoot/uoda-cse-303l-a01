...
export default function Footer() {
  const navigation = ["Official Site", "UGC", "Admission"];
  const legal = ["CSE", "ETE"];
  return (
    <div className="sticky top-[100vh]">
      <Container>
            ...
            <div>
              ...
              <Link href="/">
                <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  ...
                  <span>UCS by UODA</span>
                </a>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Faculty Of Engineering,<br></br>
              6/3 Block-E, Lalmatia, Satmasjid Road, Dhaka-1207
            </div>
          </div>
        ...
        <div className="mt-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Made with ♥ from Dhaka by{" "}
          <a href="https://github.com/aamibhoot" target="_blank" rel="noopener">
            APON 🐰
          </a>
        </div>
      </Container>
